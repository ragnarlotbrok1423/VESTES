                ...
                <?php if (!empty($addresses)): ?>
                    <?php foreach ($addresses as $address): ?>
                        <div class="bg-white rounded-lg shadow-md p-6">
                            <h3 class="text-xl font-semibold mb-2 text-darkColor">
                                <?php echo htmlspecialchars($address['name_address']); ?>
                            </h3>
                            ...
                            <?php if ($address['isActive'] != '1'): ?>
                                <form method="POST" action="">
                                    <input type="hidden" name="idAdress" value="<?php echo $address['idAdress']; ?>">
                                    <button type="submit"
                                        class="bg-pointColor text-white py-2 px-4 rounded hover:bg-red-700 transition duration-300">
                                        Hacer Activa
                                    </button>
                                </form>
                            <?php endif; ?>
