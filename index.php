...
<div class="flex flex-wrap justify-center pt-16 pb-12 gap-3">
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img class="p-8 rounded-t-lg w-[336px]" src="https://media.gq.com/photos/6081b246c1e989d69f6aa8fc/master/w_2000,h_1333,c_limit/Kirkland-Signature-men's-crewneck-T-shirts-(six-pack).jpg"  alt="product image" />
        </a>
        <div class="px-5 pb-5">
            <a href="#">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="productDetail.php" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
            </div>
        </div>
    </div>
    <!-- Cards -->
